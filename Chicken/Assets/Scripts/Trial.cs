...
public class Trial {
	...
	public override string ToString() {
		return "{collision:" + collision + ", playerSwerve:" + playerSwerve + ", robotSwerve:" + robotSwerve + ", playerRobotDistance:" + playerRobotDistance + ", playerStartDistance:" + playerStartDistance + ", robotPlayerDistance:" + robotPlayerDistance + ", robotStartDistance:" + robotStartDistance + ", trialNum:" + trialNum + ", robotType:" + robotType + ", robotMotivation:" + robotMotivation + ", humanMotivation:" + playerMotivation + "}";
	}
}
