...
#pragma warning restore
	...
	public void OverrideSwerveDistance() {
	...
	public void UpdateWidth() {
		...
		// The error margin is skewed depending on the motivation the robot has.
		// If the trial manager is not instanced yet, the pur Gaussian is used.
		TrialManager trialManager = TrialManager.instance;
		if (trialManager != null && trialManager.trials != null) {
			swerveDistance = HelperFunctions.CalculateSwerveDistance(minimumDistance, sharedVariableManager.swerveStandardDeviation, TrialManager.instance.trials[TrialManager.instance.currentTrialNum].robotMotivation);
		} else {
